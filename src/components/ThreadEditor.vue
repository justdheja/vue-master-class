  ...
  <form @submit.prevent="save">
    <div class="form-group">
      ...
      <template v-if="$v.form.title.$error">
        ...
        <span v-if="!$v.form.title.minLength" class="form-error">The title must be least 5 characters. {{5 - form.title.length}} more</span>
      </template>
    </div>
    ...
    <div class="form-group">
      ...
      <template v-if="$v.form.text.$error">
        ...
        <span v-if="!$v.form.text.minLength" class="form-error">The text of the thread must be least 10 characters. {{10 - form.text.length}} more</span>
      </template>
    </div>
