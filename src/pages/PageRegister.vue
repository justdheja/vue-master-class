      ...
      <form @submit.prevent="register" class="card card-form">
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.email.$error">
            ...
            <span v-else-if="!$v.form.email.email" class="form-error">your email must be an email</span>
          </template>
        </div>
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.password.$error">
            ...
            <span v-if="!$v.form.password.minLength" class="form-error">password must be at least 6 character</span>
          </template>
        </div>
